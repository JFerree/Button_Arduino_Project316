...
void loop() 
{
  ...
  {   
    ...
    TimeChangeRule usCDT = {"EDT", Second, Sun, Mar, 11, -360};  //UTC - 5 hours - change this as needed
    TimeChangeRule usCST = {"EST", First, Sun, Nov, 2, -420};   //UTC - 6 hours - change this as needed
